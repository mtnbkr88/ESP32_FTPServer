...
#define FTP_SERVER_VERSION "FTP-2020-01-01"

#define FTP_CTRL_PORT    21          // Command port on which server is listening  
#define FTP_DATA_PORT    22          // Data port in active mode
...
private:
  ...
  int8_t  readChar();
  boolean formatLIST( File * file, char * buffer );
  boolean formatMLST( File * file, char * buffer );
